...
export const appRoutes = [
  ...
  },
  {
    ...
    // nav Layout. Hub mode boots here (App.tsx start-page effect, M14); the
    // destructive root-swap that makes this the ONLY reachable surface lands
    // with projection-plane coexistence (§12.2), so the working projection is
    // never put at risk.
    path: `/${RoutePath.Hub}`,
    element: <HubShell />
  }
